...
#SCENES=(DETROIT)
SCENES=(AMSTERDAM)
#SCENES=(FLORENCE HARVARD MADRID PARIS SYDNEY DENVER FORT_WORTH LONDON MADRID2 PHILADELPHIA TORONTO FRANKFURT LONGISLAND MILAN PORTLAND ZURICH EL_PASO HAMBURG MADISON NY ROME)
