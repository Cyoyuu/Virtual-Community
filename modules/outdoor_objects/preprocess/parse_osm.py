...
if __name__ == '__main__':
    ...
    parser.add_argument('--parser_cfg_path', type=str, default='ViCo/modules/outdoor_objects/parser_config.yaml', help='Path to the groups configuration file')
    parser.add_argument('--assets_cfg_path', type=str, default='ViCo/modules/outdoor_objects/assets_config.yaml', help='Path to the assets configuration file')
